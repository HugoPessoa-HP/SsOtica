...
var GetSotecoControllerVendas_exports = {};
__export(GetSotecoControllerVendas_exports, {
  GetSotecoControllerVendas: () => GetSotecoControllerVendas
});
module.exports = __toCommonJS(GetSotecoControllerVendas_exports);
...
var GetSotecoControllerVendas = class {
  ex(req, res) {
    return __async(this, null, function* () {
      const getBarraMares = new GetSotecoVendas_Service();
      ...
      sheet.workbook.xlsx.writeFile(`Loja Soteco - Relat\xF3rio de -${dataAnterior}.xlsx`);
